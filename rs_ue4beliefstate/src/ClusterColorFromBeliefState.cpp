...
public:
  ClusterColorFromBeliefState(): DrawingAnnotator(__func__), nh_("~"),min_value_color_(60), min_saturation_color_(60), max_value_black_(60), min_value_white_(120), histogram_cols_(16),
